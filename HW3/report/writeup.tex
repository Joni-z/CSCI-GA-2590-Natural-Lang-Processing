...
The saved notebook in this repository does not include stored output for these two cells, and I did not rerun the full Llama-2 experiment from this shell session. So I summarize the expected comparison qualitatively rather than claiming exact numbers that I did not freshly measure:
...
\midrule
\texttt{max\_tokens = 8} & higher & higher & lower & unchanged \\
\texttt{max\_tokens = 50} & lower & lower & higher & unchanged \\
\bottomrule
\end{tabular}
\end{center}
